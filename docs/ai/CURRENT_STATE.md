...
3. Shared UI lives in `common/common.scss`; semantic aliases/settings live in `common/color_definitions.scss`; device refinements live in `desktop/desktop.scss` and `mobile/mobile.scss`.
